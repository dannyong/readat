...
class LikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create like" do
    assert_difference('Like.count') do
      post likes_url, params: { like: { status: @like.status, user_id: @like.user_id, write_id: @like.write_id } }
    end
  ...
  test "should update like" do
    patch like_url(@like), params: { like: { status: @like.status, user_id: @like.user_id, write_id: @like.write_id } }
